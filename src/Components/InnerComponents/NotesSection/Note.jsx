...
import { populateDisplaySection, unpopulateDisplaySection } from '../../../redux/display';
...
function Note(props){
    ...
    function setTags(tag){
        ...
        return <p className="note-tag" style={{backgroundColor:bgColor}}>{tag}</p>
    }
    ...
    return (
        <div className={noteClass} style={themeStyles.note} onClick={(e)=>{
         ...
         //  props.noteSelected && document.querySelector(".note-selected").setAttribute("class", "note");
            if(e.target.classList.contains("note-selected")){
                ...
                if( document.querySelector(".note-selected") !== null){
                    document.querySelector(".note-selected").setAttribute("class", noteClass);
                }

                e.target.setAttribute("class", "note note-selected");
              //  props.makeNoteSelected();
                dispatch(populateDisplaySection(
                    {
                        id: props.id, 
                        title: props.title, 
            ...
            <div className="note-bottom">
                <span className="tags-container">    
                    {
                         props.tags.map(setTags)
                    }
                </span>
                
                <div className="note-footer">
                    <p className='note-date' style={themeStyles.note.date}>{props.dateModified}</p>
